...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to shadowking!\n\nTo get a list of shadowking groups use /chats or /chatlist for a document list of chats.\n\nTo get a new shadowking group, Join my support or channel:\n\n @shadowking_TG\n\nThank you for your choose\n\n shadowking is nice.\n\n@shadowking_ch [my channel]\n@It_Is_Crazy [my developer]\n\nThanks for using @shadowking_TG!"
     	return text
    end
